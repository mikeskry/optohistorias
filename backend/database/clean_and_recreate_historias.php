...
try {
    ...
    echo "Limpiando y recreando tabla historias_clinicas...\n\n";
    
    // Eliminar todas las tablas de historias clínicas existentes
    echo "Eliminando tablas existentes...\n";
    $pdo->exec("DROP TABLE IF EXISTS historias_clinicas");
    $pdo->exec("DROP TABLE IF EXISTS historias_clinicas_old");
    $pdo->exec("DROP TABLE IF EXISTS historias_clinicas_backup");
    echo "✓ Tablas eliminadas\n\n";
    
    // Crear nueva tabla con solo los campos necesarios
    echo "Creando nueva tabla historias_clinicas...\n";
    ...
    CREATE TABLE `historias_clinicas` (
        ...
        `lensometria_formula_lejos_derecho_prisma` varchar(50) DEFAULT 'NO APLICA',
        ...
        `lensometria_formula_lejos_izquierdo_prisma` varchar(50) DEFAULT 'NO APLICA',
        ...
        `lejos_test_usado` varchar(50) DEFAULT 'LETRAS',
        `cerca_test_usado` varchar(50) DEFAULT 'LETRAS',
        ...
        `agudeza_visual_cerca_distancia` varchar(50) DEFAULT 'Cerca',
        `agudeza_visual_cerca_descripcion` varchar(50) DEFAULT 'LETRAS',
    ...
    $pdo->exec($sql);
    echo "✓ Nueva tabla historias_clinicas creada exitosamente\n\n";
    ...
    echo "\n✓ Tabla historias_clinicas recreada exitosamente con " . count($columns) . " campos\n";
