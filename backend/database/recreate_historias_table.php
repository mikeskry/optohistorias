...
try {
    ...
    echo "Recreando tabla historias_clinicas con la estructura correcta...\n\n";
    ...
    // Crear la nueva tabla con solo los campos necesarios
    echo "Creando nueva tabla con estructura correcta...\n";
    ...
    foreach ($columns as $column) {
        if (in_array($column['Field'], ['id', 'paciente_id', 'optica_id', 'fecha_consulta', 'motivo_consulta', 'tipo_examen'])) {
            echo "- {$column['Field']} ({$column['Type']})\n";
        }
    }
    
    echo "\n✓ Tabla historias_clinicas recreada correctamente con " . count($columns) . " campos\n";
